...
function getBaseDomain() {
  var domain = ((window.vk && window.vk.__domain) || 'vk.com');
...
window.Radiobuttons = window.Radiobuttons || Radiobuttons;
...
window.InlineDropdown = window.InlineDropdown || InlineDropdown;
